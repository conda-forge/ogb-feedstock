...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ogb-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10621&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ogb-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ogb` can be installed with:

```
conda install ogb
```

It is possible to list all of the versions of `ogb` available on your platform with:
